  ...
  return (
    ...
    >
      ...
      <ScrollView style={styles.content}>
        ...
        <Text style={[styles.text, { color: colors.textSecondary }]}>
          By accessing and using ZyncIT, you accept and agree to be bound by the
        ...
        <Text style={[styles.text, { color: colors.textSecondary }]}>
          ...
          materials on ZyncIT for personal, non-commercial transitory viewing
        ...
        <Text style={[styles.text, { color: colors.textSecondary }]}>
          The materials on ZyncIT are provided on an 'as is' basis. ZyncIT makes
        ...
        <Text style={[styles.text, { color: colors.textSecondary }]}>
          In no event shall ZyncIT or its suppliers be liable for any damages
          (including, without limitation, damages for loss of data or profit, or
          due to business interruption) arising out of the use or inability to
          use the materials on ZyncIT.
        </Text>
        ...
        <Text style={[styles.text, { color: colors.textSecondary }]}>
          The materials appearing on ZyncIT could include technical,
          typographical, or photographic errors. ZyncIT does not warrant that
          any of the materials on ZyncIT are accurate, complete, or current.
        </Text>
        ...
        <Text style={[styles.text, { color: colors.textSecondary }]}>
          ZyncIT may revise these terms of service for its website at any time
